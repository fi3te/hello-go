...
// MainUser defines model for main.User.
...
type ClientInterface interface {
	...
	// Secret request
	Secret(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) Home(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewHomeRequest(c.Server)
	if err != nil {
		return nil, err
	}
...
func (c *Client) Secret(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSecretRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewHomeRequest generates requests for Home
...
// NewSecretRequest generates requests for Secret
func NewSecretRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	// HomeWithResponse request
	HomeWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*HomeResponse, error)

	// SecretWithResponse request
	SecretWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*SecretResponse, error)
...
// Status returns HTTPResponse.Status
func (r SecretResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r SecretResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// HomeWithResponse request returning *HomeResponse
func (c *ClientWithResponses) HomeWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*HomeResponse, error) {
	rsp, err := c.Home(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseHomeResponse(rsp)
}

// SecretWithResponse request returning *SecretResponse
func (c *ClientWithResponses) SecretWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*SecretResponse, error) {
	rsp, err := c.Secret(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSecretResponse(rsp)
}
...
// ParseSecretResponse parses an HTTP response from a SecretWithResponse call
func ParseSecretResponse(rsp *http.Response) (*SecretResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
